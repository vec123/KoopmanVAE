...
from KoopmanVAE.systems.systems_logic import cartpole_controlled, simple_independent_linear, simple_nonlinear_spring, complex_nonlinear_system
...
class KoopmanLQRController:
    ...
    def get_control(self, x_phys):
            ...
            with torch.no_grad():
                ...
                z_curr = mu_all.cpu().numpy().reshape(-1, 1)
...
class KoopmanMPCController(KoopmanLQRController): 
