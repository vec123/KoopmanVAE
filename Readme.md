...
<br>
<br>
For many years, Koopman Operator Theory was considered a purely theoretical toy with no practical utility. However, with the 21st century data-driven finite-dimensional approximations of the linear infinite-dimensional operator started to become popular. A famous example is dynamic mode decomposition, which arose as a linear approximation method to study high-dimensional fluid simulations.
<br>
<br>
